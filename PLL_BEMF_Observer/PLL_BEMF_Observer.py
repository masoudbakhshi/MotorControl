...
#This script simulates a phase-locked loop (PLL) tracking the angle of a shrinking back-EMF vector, as would occur in a motor running down from 100 rpm to 0. 
#The animation shows how the PLL phase error increases as the signal fades, and includes a lock indicator and speed panel.
